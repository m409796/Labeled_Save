...
namespace EasyTransition
{
    ...
    {        
        ...
        public static TransitionManager Instance
        {
            get
            {
                if (instance == null) instance = GameObject.FindObjectOfType<TransitionManager>();
                return instance;
            }
        }
        ...
        /// <summary>
        /// Starts a transition and moves the player to a new position.
        /// </summary>
        /// <param name="transition">The settings of the transition you want to use.</param>
        /// <param name="startDelay">The delay before the transition starts.</param>
        /// <param name="player">The player GameObject to move.</param>
        /// <param name="newPosition">The new position to move the player.</param>
        public void Transitions(TransitionSettings transition, float startDelay, GameObject player, Vector2 newPosition)
        {
            if (transition == null || runningTransition)
            {
            ...
            runningTransition = true;
            StartCoroutine(Timer(startDelay, transition, player, newPosition));
        }
        ...
        //IEnumerator Timer(float delay, TransitionSettings transitionSettings, GameObject player, Vector2 newPosition)
        //{
        ...
        //    // Destroy or hide the transition object since we don't load a new scene
        //    Destroy(template); // OR template.SetActive(false);
        ...
        IEnumerator Timer(float delay, TransitionSettings transitionSettings, GameObject player, Vector2 newPosition)
        {
            ...
            Destroy(template); // Remove transition object after fade-out
