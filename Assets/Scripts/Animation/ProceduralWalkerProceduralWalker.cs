...
public class ProceduralWalker : MonoBehaviour
{
    ...
    private float _currentCycleSpeed, _currentBodyBobAmount;
    private float _currentArmSwingAngle, _currentElbowDragAngle, _currentHeadBobAmount;
    private float _currentNeckSwingAngle, _currentTailSwingAngle;
    ...
    void Start()
    {
        ...
        bool walkProfileLooksDefault = Mathf.Approximately(walkProfile.cycleSpeed, 0f) && Mathf.Approximately(walkProfile.armSwingAngle, 0f);
        if (walkProfileLooksDefault)
        {
            ...
            runProfile.armSwingAngle = armSwingAngle * 1.5f; // Kept a generic multiplier
    ...
    void Reset()
    {
        ...
        runProfile.cycleSpeed = walkCycleSpeed * runCycleSpeedMultiplier;
        runProfile.bodyBobAmount = bodyBobAmount * runBodyBobMultiplier;
        runProfile.armSwingAngle = armSwingAngle * 1.5f;
        runProfile.elbowDragAngle = elbowDragAngle;
        runProfile.headBobAmount = headBobAmount * runBodyBobMultiplier;
        runProfile.neckSwingAngle = neckSwingAngle * 1.1f;
        runProfile.tailSwingAngle = tailSwingAngle * 1.3f;
